...
BATCH_SIZE = 16 # MAKE SURE BATCH_SIZE ARE FACTORS OF HARDSTOP_TST AND HARDSTO
...
netp = SQNN(bz = BATCH_SIZE, rand_params=_rand_params, q_dev = dev, w=WIRES) # initializes REG convnet; nc = input should have 1 channel
