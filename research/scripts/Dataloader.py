...
def generate_generators(data_root, hdf_data_path,BZ,IR,
    ...
    trn_gen = DataGenerator(data_root, trn_files, hdf_data_path,  BZ)
...
class DataGenerator:
    ...
    def __next__(self):
        ...
        self.first_slice += 1
        self.last_slice += 1
        return batch_data, batch_label, self.bsz_by_class, self.clutter_len, self.target_len, self.batch_size
